...
% \usepackage[a4paper, top=0.65in, bottom=0.65in]{geometry}
\usepackage[a4paper, top=0.5in, bottom=0.7in, left=0.65in, right=0.65in]{geometry}
...
\begin{center}
{\Large \textbf{Xibin Bayes Zhou (周禧彬)}}\\[0.08cm]
\textit{Protein foundation models for search, dialogue, and design}\\[0.04cm]
\textit{Ph.D. Candidate in Computer Science, Westlake University \& Zhejiang University, Hangzhou}\\[0.04cm]
...
\begin{itemize}
    ...
    \item High School, Tianjin Nankai School, Tianjin, China (2015--2018)
\end{itemize}

\section*{Research Interests}
\begin{itemize}
    \item \textbf{Structure-aware protein language modeling} --- Integrating 3D structure tokens with sequence for general~PLMs
    \item \textbf{Multimodal protein understanding} --- Aligning sequence, structure, and language for protein search \& annotation
    \item \textbf{AI-driven protein engineering} --- Enzyme optimization, base editing, de novo design, and autonomous lab workflows
    \item \textbf{Democratizing PLM research} --- No-code PLM training platforms and open collaboration for biologists
\end{itemize}
...
\begin{itemize}
    \item Contributor to Hugging Face \textbf{Transformers} (Evolla integration) --- \href{https://github.com/huggingface/transformers/commit/45c7bfb1571160d2c06b880073a5c73e6bfa3677}{commit}
    \item \textbf{Evolla} post on X: 130K+ views --- \href{https://x.com/duguyuan/status/1876446845951492221}{post}
    \item \textbf{Evolla} on Hugging Face: $\sim$100K downloads/month --- \href{https://huggingface.co/westlake-repl/Evolla-10B-hf}{model}
    \item \textbf{Pinal} featured in \textit{Nature News} (May 2025) --- \href{https://www.nature.com/articles/d41586-025-01586-y}{article}
    \item Research featured in \textbf{Westlake University} press (ProTrek / trimodal PLM) --- \href{https://www.westlake.edu.cn/news_events/westlakenews/Research/202510/t20251030_60873.html}{news}
\end{itemize}
...
\begin{itemize}
    \item Former \textbf{President}, Westlake Water Sports Club; \textbf{Rowing} (4 yrs, captain); \textbf{SUP} (3 yrs); sailing, dragon boat, and~SUP~polo
\end{itemize}
